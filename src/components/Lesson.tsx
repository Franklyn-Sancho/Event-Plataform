...
//Propriedades das aulas e seus tipos
...
//função responsável por renderizar as aulas
export function Lesson(props: LessonProps) {
  ...
  const availableDateFormatted = format(
    props.availableAt,
    "EEEE' . 'd' de 'MMMM' . 'k'h'mm", //formato da função Date() no padrão PTBR
    {
      locale: ptBR, //Conversão para PTBR
    }
  );
